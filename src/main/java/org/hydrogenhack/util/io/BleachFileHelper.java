 ...
 */
package org.hydrogenhack.util.io;
...
import org.hydrogenhack.gui.clickgui.window.ClickGuiWindow;
...
public class BleachFileHelper {
	...
	public static void readFriends() {
		HydrogenHack.friendMang.addAll(BleachFileMang.readFileLines("friends.txt"));
	}

	public static void saveFriends() {
		String toWrite = "";
		for (String s : HydrogenHack.friendMang.getFriends())
			toWrite += s + "\n";
