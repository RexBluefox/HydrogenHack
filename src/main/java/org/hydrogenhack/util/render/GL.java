...
import org.hydrogenhack.mixin.AccessorBufferRenderer;
import org.hydrogenhack.mixin.ICapabilityTracker;
...
public class GL {
    ...
    public static void bindVertexArray(int vao) {
        ...
        if (changeBufferRenderer) AccessorBufferRenderer.setCurrentVertexBuffer(null);
    }
