...
import org.hydrogenhack.util.shader.BleachCoreShaders;
import org.hydrogenhack.util.shader.ColorVertexConsumerProvider;
import org.hydrogenhack.util.shader.ShaderEffectWrapper;
import org.hydrogenhack.util.shader.ShaderLoader;
...
public class ESP extends Module {
	...
	private int[] getColor(Entity e) {
		...
		if (e instanceof PlayerEntity && getSetting(4).asToggle().getState()) {
			return getSetting(4).asToggle().getChild(HydrogenHack.friendMang.has(e) ? 1 : 0).asColor().getRGBArray();
