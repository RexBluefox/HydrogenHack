package org.hydrogenhack.command;
...
import org.hydrogenhack.event.events.EventKeyPress;
...
import org.hydrogenhack.mixin.AccessorChatScreen;
...
public class CommandSuggestor {
	...
	public static void start() {
		HydrogenHack.eventBus.subscribe(getInstance());
	}

	public static void stop() {
		getInstance().reset();
		HydrogenHack.eventBus.unsubscribe(getInstance());
	}
