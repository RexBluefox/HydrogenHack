...
import org.hydrogenhack.gui.window.widget.WindowScrollbarWidget;
import org.hydrogenhack.gui.window.widget.WindowTextWidget;
import org.hydrogenhack.gui.window.widget.WindowWidget;
import org.hydrogenhack.util.collections.ImmutablePairList;
...
public class BleachCreditsScreen extends WindowScreen {
	...
	public void init() {
		...
		getWindow(0).addWidget(new WindowTextWidget(HydrogenHack.watermark.getText(), true, WindowTextWidget.TextAlign.MIDDLE, 3f, w / 2, 22, 0xb0b0b0));
		getWindow(0).addWidget(new WindowTextWidget(HydrogenHack.VERSION, true, WindowTextWidget.TextAlign.MIDDLE, 1.5f, w / 2, 41, 0xffc050));
