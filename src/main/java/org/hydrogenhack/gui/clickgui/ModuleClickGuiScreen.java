 ...
 */
package org.hydrogenhack.gui.clickgui;
...
import org.hydrogenhack.gui.clickgui.window.ModuleWindow;
...
public class ModuleClickGuiScreen extends ClickGuiScreen {
	...
	public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
		...
		textRenderer.draw(matrices, "BleachHack-" + HydrogenHack.VERSION + "-" + SharedConstants.getGameVersion().getName(), 3, 3, 0x305090);
		textRenderer.draw(matrices, "BleachHack-" + HydrogenHack.VERSION + "-" + SharedConstants.getGameVersion().getName(), 2, 2, 0x6090d0);
