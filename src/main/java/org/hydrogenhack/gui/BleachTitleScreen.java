...
import org.hydrogenhack.gui.effect.ParticleManager;
...
import org.hydrogenhack.module.mods.UI;
...
public class BleachTitleScreen extends WindowScreen {
	...
	public void init() {
		...
		addWindow(new Window(width / 8,
				height / 8,
				width - width / 8,
				height - height / 8 + 2, "HydrogenHack", new ItemStack(Items.MUSIC_DISC_CAT)));
		...
		// Version Text
		getWindow(0).addWidget(new WindowTextWidget(HydrogenHack.VERSION, true, WindowTextWidget.TextAlign.MIDDLE, 1.5f, w / 2, h / 4 - 6, 0xffc050));
